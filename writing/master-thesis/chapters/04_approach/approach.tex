...
\input{chapters/04_approach/sections/01_idea}

\input{chapters/04_approach/sections/02_architecture_and_procedure}

\input{chapters/04_approach/sections/03_scoring_of_triples}

\input{chapters/04_approach/sections/04_feature_functions}

\input{chapters/04_approach/sections/05_generator_score}

\input{chapters/04_approach/sections/06_probabilities}

\input{chapters/04_approach/sections/07_uncertainty}

\input{chapters/04_approach/sections/08_sampling_by_uncertainty}