...
In this common technique of Negative Sampling either the head or the tail entity in a given positive triple \triple{h}{r}{t} is replaced by any other entity of the \ac{KG} which remains in the new negative triple \triple{h’}{r}{t} or \triple{h}{r}{t’}. 
