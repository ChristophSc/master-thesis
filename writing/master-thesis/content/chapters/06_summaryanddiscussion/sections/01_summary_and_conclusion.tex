...
% conclusion
In conclusion, our evaluation of \ucgan with different uncertainty metrics, sampling methods and on different datasets shows that it is possible to learn embeddings with uncertainty sampling method.
...
Thus, it can be said that in most cases the results are still not as good as those of original sampling in \kbgan which might have several reasons which are marked for future work explained in \Autoref{sec:futurework}.
