...
In uniform negative random sampling, either the head or the tail entity in a given positive triple \triple{h}{r}{t} is randomly replaced by any other entity of the \ac{KG}.
This remains in the new negative triple \triple{h’}{r}{t} or \triple{h}{r}{t’}. 
