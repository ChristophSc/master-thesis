...
In \Autoref{fig:uncertainty_sampling_heatmap} an example of target areas for the different uncertainty measures are illustrated when there are three labels.
