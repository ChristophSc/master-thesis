...
\end{enumerate}
\cite{electronics9050750} separated two different categories for \acp{KGE}: Triplet Fact-Based Representation Learning Models (\Autoref{subsec:triplet_fact_based_representation_learning_models}) and Description-Based Representation Learning Models (\Autoref{subsec:description_based_representation_learning_models}).
