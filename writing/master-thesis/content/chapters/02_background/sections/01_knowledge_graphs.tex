...
\end{itemize}
In addition, the inverse of a relation \texttt{r} is denoted as $\texttt{r}^{-1}$.
For any two entities \texttt{h} and \texttt{t} applies: 
\triple{h}{r}{t} $\in$ \kg $\iff (\texttt{t},\texttt{r}^{-1},\texttt{h}) \in \kg$ \cite{ConEx}.