...
In \Autoref{tab:uncertainty_measure_example_distribution}, for all triples and all uncertainty metrics the sampling probabilities are displayed.
\input{content/chapters/03_approach/sections/table_uncertainty_measure_example_distribution}
