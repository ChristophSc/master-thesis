...
As shown in \Autoref{fig:uncertainty_sampling_component}, the Uncertainty Sampling component is divided into three sub-components and steps.
...
It receives the negative triple scores $s_i \in \mathbb{R}$ from the generator as input and returns a probability for each negative triple $(h',r,t') \in Neg$ to be positive  ($\mathbb{P}(y = 1| (h',r,t'))$) (\Autoref{eqn:positive_probability}) as output. 
...
As can be seen in \Autoref{tab:uncertainty_measure_example_max}, 
