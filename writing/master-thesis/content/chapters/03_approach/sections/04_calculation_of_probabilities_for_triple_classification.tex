...
Based on \Autoref{fig:positiveVsNegativeApproach}, we have the following two options for the determination of scoring boundaries.
...
Consequently, the probability of a triple to be positive ($y = 1$) can be calculated with following \Autoref{eqn:positive_probability}.
