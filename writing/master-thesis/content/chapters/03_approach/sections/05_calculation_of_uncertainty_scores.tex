...
\end{equation}
Since \Autoref{eq:leastconfidence} and \ref{eq:marginofconfidence} are equal, for binary classification sampling by a margin of confidence is the same as sampling by least confidence.
