...
\end{equation}
Since \Autoref{eqn:leastconfidence} and \ref{eq:marginofconfidence} are equal, for binary classification sampling by nargin of confidence is the same as sampling by least confidence.
