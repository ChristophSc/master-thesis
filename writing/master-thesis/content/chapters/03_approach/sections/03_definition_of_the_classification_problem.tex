...
Therefore, including positive triple scoring information result in sampling triples from a different scoring area illustrated in \Autoref{fig:positiveVsNegativeApproach}
\begin{figure}[H]
  \centering
