...
Until now, only information on the scoring function of the generator is used for the classification of the triple as either positive or negative.
...
\begin{itemize}
    \item 
    \emph{\ac{PEER}:} 
    Relative frequency of peers within a peer group that is related to different objects, e.g. 0.9 if persons are married. 
    \begin{equation}
...
To incorporate this information in the score function than just the embedding of a triple, we want to extend the original score function $f_G$ by information about entities and relations in the \ac{KG}.
