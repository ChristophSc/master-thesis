...
For this purpose, the courses of the validation metrics of the two methods on different data sets are presented in \Autoref{subsec:methods_results}.
...
% conclusion
In conclusion, adversarial training seems to work with both sampling methods.
