...
%
When training \usgan on \textsc{WN18RR} with the different uncertainty measures, a similar progression of the MRR value can be seen (\Autoref{fig:advtrain_metrics_wn18rr}).
In contrast to learning on the \umls dataset, however, the maximum is reached after just over 200 epochs.

Looking at the rewards, an increase in rewards can be seen with all model pairs and uncertainty measures (\Autoref{fig:advtrain_metrics_wn18rr_rew}).
