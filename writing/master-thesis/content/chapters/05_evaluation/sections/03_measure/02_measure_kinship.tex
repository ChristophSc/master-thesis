...
When looking at the development of the losses and rewards in figure X, it is particularly striking that the rewards with a \transe discriminator develop significantly differently than those with a \transd discriminator (\Autoref{fig:advtrain_metrics_kinship_rew}).
