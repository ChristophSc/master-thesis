...
If you look at the rewards over the course (\Autoref{fig:advtrain_metrics_umls_rew}), you can also see an increase right at the beginning of the training, but is steadily decreasing after reaching the maximum value.
\begin{figure}[H]
    \centering
    \begin{minipage}{.5\textwidth}
      \centering
