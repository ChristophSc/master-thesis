...
%
Also for the adversarial training on the WN18 dataset, the development of the MRR value is similar for all uncertainty measures (\Autoref{fig:advtrain_measures_wn18}).
\begin{figure}[H]
    \centering
