...
%
Comparing different courses of MRR values with all four different uncertainty metrics on \textsc{FB15k-237} look similar too (\Autoref{fig:advtrain_measures_fb15k237}).In this case, model pairs with \transd discriminators learn slower in the beginning, but catch up in the end.
