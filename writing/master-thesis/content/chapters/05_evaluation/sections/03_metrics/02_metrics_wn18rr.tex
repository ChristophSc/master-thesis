...
When training \ucgan on \textsc{WN18RR} with the different uncertainty metrics, a similar progression of the MRR value can be seen (\Autoref{fig:advtrain_metrics_wn18rr}).
\begin{figure}
    \centering
