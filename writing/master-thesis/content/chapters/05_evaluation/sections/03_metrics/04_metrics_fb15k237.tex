...
\label{subsec:metrics_fb15k237}


Comparing different courses of MRR values with all four different uncertainty metrics on \textsc{FB15k-237} look similar too (\Autoref{fig:advtrain_metrics_fb15k237}).
\begin{figure}
    \centering
