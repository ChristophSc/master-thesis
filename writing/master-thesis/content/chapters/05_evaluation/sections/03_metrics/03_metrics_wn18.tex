...
Also for the adversarial training on the WN18 dataset, the development of the MRR value is similar for all uncertainty metrics (\Autoref{fig:advtrain_metrics_wn18}).
\begin{figure}
    \centering
