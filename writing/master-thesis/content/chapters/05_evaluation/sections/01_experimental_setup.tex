...
Statistics of all used datasets containing the number of relations and entities, heads, and tails are shown in \Autoref{tab:datasets}. 
...
As example, \Autoref{fig:original_pretrained_advtrain} shows validation results of adversarial training process on the\textsc{FB15k-237} dataset.
...
This process is depicted in \Autoref{fig:original_not_pretrained_advtrain}.
\begin{figure}
    \centering
    \begin{minipage}{.5\textwidth}
      \centering
