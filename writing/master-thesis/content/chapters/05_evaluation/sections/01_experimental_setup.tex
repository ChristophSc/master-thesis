...
evaluation task: entity ranking
...
% In addition, the training was enforced in \textsc{KBGAN's} original approach for 5000 epochs.
% However, the first and most important changes in the metrics can already be seen in the first 1000 epochs, especially when this takes place without pre-training.
% For this reason, in our evaluation we will focus and display only on first 1000 epochs.
