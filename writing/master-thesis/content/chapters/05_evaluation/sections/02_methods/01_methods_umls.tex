...
The evolution of the MRR and Hit@10 values at the validation set on the \umls data set can be seen in \Autoref{fig:advtrain_umls_not_pretrained_uncertainty_max}.
\begin{figure}
    \centering
