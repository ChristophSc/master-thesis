...
\end{figure}
If the training losses and rewards of \usmax and \usmax on \textsc{FB15k-237} are compared, a similar behaviour as on \textsc{WN18} and \textsc{WN18RR} can be seen (\Autoref{fig:advtrain_fb15k237_usmax_ussoftmax_losses_rewards}).
