...
%
In contrast to the evaluation metrics for the \umls dataset, the two evaluation metrics for the \textsc{WN18RR} dataset look relatively similar as can be seen in \Autoref{fig:advtrain_wn18rr_usmax_ussoftmax}.
\begin{figure}[H]
    \centering
