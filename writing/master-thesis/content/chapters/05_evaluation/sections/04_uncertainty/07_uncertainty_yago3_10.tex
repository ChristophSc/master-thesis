...
Looking at the rewards in \Autoref{fig:advtrain_yago3_10_losses_rewards}, they also descrease for the new samplign approach and thus the sampled negative triples are better in the original approach and improve steadily over time, while in the new approach a decreasing reward is obtained on this data set.
\begin{figure}[H]
    \centering
    \begin{minipage}{.5\textwidth}
      \centering
