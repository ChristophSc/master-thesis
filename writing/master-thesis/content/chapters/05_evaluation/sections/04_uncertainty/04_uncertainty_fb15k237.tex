...
As depicted in \Autoref{fig:advtrain_fb15k237_random_vs_uncertainty}, with \origssampling a maximum MRR almost 26\% and a Hit@10 pf about 43\%.
\begin{figure}
    \centering
...
While adversarial training with \origssampling reaches a local minimum at 50 epochs and continues increasing reward afterwards.
...
\end{figure}
Surprisingly, training losses with \origssampling look even very different to losses on other datasets.
