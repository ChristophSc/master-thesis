...
%
Looking at the results of the evaluation metrics MRR and Hit@10 on the \textsc{FB15k} dataset, both the learning curves and the maximum achieved values look very similar (\Autoref{fig:advtrain_fb15k_random_vs_uncertainty}).
