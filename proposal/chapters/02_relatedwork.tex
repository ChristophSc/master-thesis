...
\end{enumerate}
By this procedure of the adversarial training the dynamic distribution of the negative triple is determined. 
...
It is used in machine learning approaches, where unlabeled data is abundant, but it is difficult, time-consuming, or expensive to obtain labeled data and aim for greater accuracy with fewer labeled training instances \cite{Settles2009ActiveLL}.
...
\end{enumerate}
There are several other query strategies in Active Learning, e.g. Query-By-Committee, Expected Model Change, Variance Reduction, Fisher Information Ration, Estimated Error Reduction and 
